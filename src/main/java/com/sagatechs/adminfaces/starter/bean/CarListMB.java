    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
                ...
                com.sagatechs.adminfaces.starter.infra.model.SortOrder order = null;
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? com.sagatechs.adminfaces.starter.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? com.sagatechs.adminfaces.starter.infra.model.SortOrder.DESCENDING
                            : com.sagatechs.adminfaces.starter.infra.model.SortOrder.UNSORTED;
                }
